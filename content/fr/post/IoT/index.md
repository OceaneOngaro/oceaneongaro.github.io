...
Il ne reste plus qu'à téléverser le code source disponible ([Lien GitLab TTGO](https://gitlab.com/AlyssaShep/ttgo-tdisplay)) avec Arduino IDE avec les paramètres suivants :
